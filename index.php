<?php
// rename this file to index.php in order to run the project 
// without this, the project will not run will resolve to the index page, thus exposing critical information
session_start();

require 'includes/database.php';
// ensure user is logged in first without this , user will be redirected to dashboard page without login.
...
if (isset($_FILES['attachment']) && $_FILES['attachment']['error'] == UPLOAD_ERR_OK) {
    ...
    if (move_uploaded_file($_FILES['attachment']['tmp_name'], $targetFile)) {
        // Save $targetFile path to the database with the task
    } else {
        // Handle upload error
    }
}
...
<body>
    ...
    <div class="container">
        ...
        <label for="attachment">Attach File:</label>
            <input type="file" id="attachment" name="attachment"></form>
            </form>
        </div>
